              ...
              <div className="flex flex-col justify-center space-y-6 animate-fade-in-up">
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  {[
                    ...
                    { icon: Star, label: "5-Star Service", desc: "22 years of experience" },
            ...
            <div className="grid gap-10 lg:grid-cols-[300px_1fr] items-center max-w-5xl mx-auto">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  With 22 years of experience serving Oakville homeowners, Ken combines deep local knowledge with modern marketing to help sellers get top dollar. As a Broker with Royal LePage Signature Realty, Ken brings the resources of Canada&apos;s largest real estate network to every client.
                </p>
                <div className="flex flex-wrap gap-4 pt-2">
                  {[
                    "22 years in Oakville",
                    "Oakville specialist",
                    "Royal LePage",
