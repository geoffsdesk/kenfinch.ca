---
title: 'Mortgage Pre-Approval Explained: How It Works in Ontario in 2026'
date: '2026-09-02'
category: mortgage
image: '/hero_house.png'
excerpt: 'What a mortgage pre-approval actually is, how lenders calculate what you can borrow, how the stress test works, what a rate hold does, and why a broker pre-approval beats a bank pre-qualification when you are buying in Oakville or the GTA.'
---
...
The [two-minute check on this site](/mortgage#apply) is a pre-qualification, deliberately: no credit inquiry, no obligation. It exists so I can call you with an honest read before you commit to anything. The secure application that follows is what produces a real pre-approval.
